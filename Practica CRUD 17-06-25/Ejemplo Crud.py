#Ejemplo1
import os 
#Importamos el modulo os es para usar la funcion: os.path.exists(ruta)
ARCHIVO = "estudiantes.txt"

def cargar_estudiantes():
    estudiantes = []
    #La funcion os.path.exists() verifica si un archivo o carpeta existe en una determinada ruta
